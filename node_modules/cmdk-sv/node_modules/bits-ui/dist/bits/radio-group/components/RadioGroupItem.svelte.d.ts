...
declare const __propDef: {
    ...
    slots: {
        default: {
            builder: ((props: import("@melt-ui/svelte/index.js").RadioGroupItemProps) => {
                ...
                action: (node: HTMLElement) => import("@melt-ui/svelte/internal/types").MeltActionReturn<"keydown" | "click" | "focus">;
            };
