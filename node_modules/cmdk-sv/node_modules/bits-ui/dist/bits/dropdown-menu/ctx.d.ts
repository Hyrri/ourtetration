...
import { type CreateDropdownSubmenuProps as DropdownSubmenuProps, type DropdownMenu as DropdownMenuReturn, type CreateMenuRadioGroupProps as DropdownRadioGroupProps, type DropdownMenuRadioGroup as DropdownRadioGroupReturn, type DropdownMenuSubmenu as DropdownSubmenuReturn, type CreateDropdownMenuCheckboxItemProps as DropdownCheckboxItemProps, type CreateDropdownMenuProps } from "@melt-ui/svelte";
...
export declare function setRadioItem(value: string): DropdownRadioGroupReturn;
export declare function getRadioIndicator(): {
    isChecked: Readable<(itemValue: string) => boolean>;
    value: string;
};
export declare function getSubTrigger(): DropdownSubmenuReturn;
export declare function getContent(sideoffset?: number): DropdownMenuReturn;
export declare function getSubContent(sideOffset?: number): DropdownSubmenuReturn;
...
export declare function setArrow(size?: number): DropdownMenuReturn;
