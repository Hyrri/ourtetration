...
export declare function createPinInput(props?: CreatePinInputProps): {
    ids: {
        root: import("svelte/store").Writable<string>;
    };
    elements: {
        ...
        input: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[{
            ...
            set: (this: void, value: string[]) => void;
            subscribe(this: void, run: import("svelte/store").Subscriber<string[]>, invalidate?: import("svelte/store").Invalidator<string[]> | undefined): import("svelte/store").Unsubscriber;
        }, import("svelte/store").Writable<string>, import("svelte/store").Writable<boolean>, import("svelte/store").Writable<"text" | "password">], (node: HTMLInputElement) => MeltActionReturn<PinInputEvents['input']>, ([$value, $placeholder, $disabled, $type]: [string[], string, boolean, "text" | "password"]) => () => {
            'data-complete': string | undefined;
            placeholder: string;
        ...
        hiddenInput: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[import("svelte/store").Readable<string>, import("svelte/store").Writable<string | undefined>], import("svelte/action").Action<any, any, Record<never, any>>, ([$valueStr, $nameStore]: [string, string | undefined]) => {
            value: string;
    ...
    options: {
        ...
        type: import("svelte/store").Writable<"text" | "password">;
        ...
        defaultValue: import("svelte/store").Writable<string[]>;
