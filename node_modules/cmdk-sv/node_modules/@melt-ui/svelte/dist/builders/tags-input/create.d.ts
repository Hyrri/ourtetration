...
export declare function createTagsInput(props?: CreateTagsInputProps): {
    ...
    elements: {
        root: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[import("svelte/store").Writable<boolean>], (node: HTMLElement) => MeltActionReturn<TagsInputEvents['root']>, ([$disabled]: [boolean]) => {
        ...
        deleteTrigger: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[import("svelte/store").Writable<Tag | null>, import("svelte/store").Writable<Tag | null>, import("svelte/store").Writable<boolean>, import("svelte/store").Writable<boolean>], (node: HTMLElement) => MeltActionReturn<TagsInputEvents['deleteTrigger']>, ([$selected, $editing, $disabled, $editable]: [Tag | null, Tag | null, boolean, boolean]) => (tag: TagProps) => {
        ...
        edit: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[import("svelte/store").Writable<Tag | null>, import("svelte/store").Writable<boolean>], (node: HTMLElement) => MeltActionReturn<TagsInputEvents['edit']>, ([$editing, $editable]: [Tag | null, boolean]) => (tag: Tag) => {
            'aria-hidden': boolean;
            'data-tag-id': string;
            'data-tag-value': string;
        ...
        tag: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[import("svelte/store").Writable<Tag | null>, import("svelte/store").Writable<Tag | null>, import("svelte/store").Writable<boolean>, import("svelte/store").Writable<boolean>], (node: HTMLDivElement) => MeltActionReturn<TagsInputEvents['tag']>, ([$selected, $editing, $disabled, $editable]: [Tag | null, Tag | null, boolean, boolean]) => (tag: TagProps) => {
    ...
    options: {
        ...
        blur: import("svelte/store").Writable<import("./types.js").Blur>;
        ...
        onTagsChange?: import("svelte/store").Writable<import("../../internal/helpers/index.js").ChangeFn<Tag[]> | undefined> | undefined;
        unique: import("svelte/store").Writable<boolean>;
        addOnPaste: import("svelte/store").Writable<boolean>;
        maxTags: import("svelte/store").Writable<number | undefined>;
        allowed: import("svelte/store").Writable<string[]>;
        denied: import("svelte/store").Writable<string[]>;
        remove: import("svelte/store").Writable<import("./types.js").RemoveTag | undefined>;
    };
};
