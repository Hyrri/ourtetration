...
export declare function createSwitch(props?: CreateSwitchProps): {
    ...
    options: {
        ...
        name: import("svelte/store").Writable<string>;
        required: import("svelte/store").Writable<boolean>;
        defaultChecked: import("svelte/store").Writable<boolean>;
        onCheckedChange?: import("svelte/store").Writable<import("../../internal/helpers/index.js").ChangeFn<boolean> | undefined> | undefined;
    };
};
