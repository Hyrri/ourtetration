...
export declare function createDateRangePicker(props?: CreateDateRangePickerProps): {
    elements: {
        trigger: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[import("../../internal/helpers/index.js").ExplicitBuilderReturn<[{
            ...
            readonly id: string;
        }, string>], (node: HTMLElement) => MeltActionReturn<DateRangePickerEvents['trigger']>, ([$trigger]: [{
            readonly role: "button";
            readonly 'aria-haspopup': "dialog";
            readonly 'aria-expanded': boolean;
            readonly 'data-state': "open" | "closed";
        ...
        field: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[import("svelte/store").Readable<import("@internationalized/date").DateValue | undefined>, import("svelte/store").Readable<boolean>, import("svelte/store").Readable<{
            field: string;
            label: string;
            description: string;
        }>], <Node_2 extends any>() => {
        ...
        label: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[import("svelte/store").Writable<string>], import("svelte/action").Action<any, any, Record<never, any>>, ([$labelId]: [string]) => {
            id: string;
        }, string>;
        startSegment: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[import("svelte/store").Writable<import("../date-field/_internal/types.js").DateSegmentObj | import("../date-field/_internal/types.js").DateAndTimeSegmentObj>, import("svelte/store").Writable<12 | 24 | undefined>, {
        ...
        endSegment: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[import("svelte/store").Writable<import("../date-field/_internal/types.js").DateSegmentObj | import("../date-field/_internal/types.js").DateAndTimeSegmentObj>, import("svelte/store").Writable<12 | 24 | undefined>, {
            set: (this: void, value: import("@internationalized/date").DateValue) => void;
            update: (this: void, updater: import("svelte/store").Updater<import("@internationalized/date").DateValue>) => void;
            subscribe: (this: void, run: import("svelte/store").Subscriber<import("@internationalized/date").DateValue>, invalidate?: import("svelte/store").Invalidator<import("@internationalized/date").DateValue> | undefined) => import("svelte/store").Unsubscriber;
            add: (duration: import("@internationalized/date").DateTimeDuration | import("@internationalized/date").DateDuration) => void;
        ...
        startHiddenInput: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[{
            update: (updater: import("svelte/store").Updater<import("@internationalized/date").DateValue | undefined>, sideEffect?: ((newValue: import("@internationalized/date").DateValue | undefined) => void) | undefined) => void;
            set: (this: void, value: import("@internationalized/date").DateValue | undefined) => void;
            subscribe(this: void, run: import("svelte/store").Subscriber<import("@internationalized/date").DateValue | undefined>, invalidate?: import("svelte/store").Invalidator<import("@internationalized/date").DateValue | undefined> | undefined): import("svelte/store").Unsubscriber;
        ...
        endHiddenInput: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[{
            update: (updater: import("svelte/store").Updater<import("@internationalized/date").DateValue | undefined>, sideEffect?: ((newValue: import("@internationalized/date").DateValue | undefined) => void) | undefined) => void;
            set: (this: void, value: import("@internationalized/date").DateValue | undefined) => void;
            subscribe(this: void, run: import("svelte/store").Subscriber<import("@internationalized/date").DateValue | undefined>, invalidate?: import("svelte/store").Invalidator<import("@internationalized/date").DateValue | undefined> | undefined): import("svelte/store").Unsubscriber;
        }, import("svelte/store").Writable<string | undefined>, import("svelte/store").Writable<boolean>, import("svelte/store").Writable<boolean>], import("svelte/action").Action<any, any, Record<never, any>>, ([$value, $nameStore, $disabled, $required]: [import("@internationalized/date").DateValue | undefined, string | undefined, boolean, boolean]) => {
        ...
        calendar: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[import("svelte/store").Readable<string>, import("svelte/store").Readable<boolean>, import("svelte/store").Writable<string>, import("svelte/store").Writable<boolean>, import("svelte/store").Writable<boolean>], (node: HTMLElement) => MeltActionReturn<"keydown">, ([$fullCalendarLabel, $isInvalid, $calendarId, $disabled, $readonly]: [string, boolean, string, boolean, boolean]) => {
            id: string;
            role: string;
            'aria-label': string;
            'data-invalid': string | undefined;
        ...
        grid: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[import("svelte/store").Writable<string>, import("svelte/store").Writable<boolean>, import("svelte/store").Writable<boolean>], import("svelte/action").Action<any, any, Record<never, any>>, ([$gridId, $readonly, $disabled]: [string, boolean, boolean]) => {
            tabindex: number;
            id: string;
            role: string;
            'aria-readonly': string | undefined;
        ...
        cell: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[import("svelte/store").Readable<(date: import("@internationalized/date").DateValue) => boolean>, import("svelte/store").Readable<(date: import("@internationalized/date").DateValue) => boolean>, import("svelte/store").Readable<(date: import("@internationalized/date").DateValue) => boolean>, import("svelte/store").Readable<{
            ...
            nextPage: (amount: number) => void;
            prevPage: (amount: number) => void;
        }, import("svelte/store").Readable<(date: import("@internationalized/date").DateValue) => boolean>], (node: HTMLElement) => MeltActionReturn<"click" | "focusin" | "mouseenter">, ([$isSelected, $isSelectionEnd, $isSelectionStart, $highlightedRange, $isDateDisabled, $isDateUnavailable, $placeholder, $isOutsideVisibleMonths,]: [(date: import("@internationalized/date").DateValue) => boolean, (date: import("@internationalized/date").DateValue) => boolean, (date: import("@internationalized/date").DateValue) => boolean, {
            start: import("@internationalized/date").DateValue;
            end: import("@internationalized/date").DateValue;
    ...
    states: {
        ...
        endSegmentValues: import("svelte/store").Writable<import("../date-field/_internal/types.js").DateSegmentObj | import("../date-field/_internal/types.js").DateAndTimeSegmentObj>;
        startSegmentValues: import("svelte/store").Writable<import("../date-field/_internal/types.js").DateSegmentObj | import("../date-field/_internal/types.js").DateAndTimeSegmentObj>;
    ...
    options: {
        ...
        onValueChange?: import("svelte/store").Writable<import("../../internal/helpers/index.js").ChangeFn<import("../../internal/helpers/date/index.js").DateRange> | undefined> | undefined;
        defaultValue: import("svelte/store").Writable<import("../../internal/helpers/date/index.js").DateRange | undefined>;
        required?: import("svelte/store").Writable<boolean | undefined> | undefined;
        ...
        startName: import("svelte/store").Writable<string | undefined>;
        endName: import("svelte/store").Writable<string | undefined>;
        ...
        endIds?: import("svelte/store").Writable<Partial<{
            label: string;
            description: string;
            month: string;
            year: string;
        ...
        ids?: import("svelte/store").Writable<Partial<{
            grid: string;
            calendar: string;
            accessibleHeading: string;
        }> | undefined> | import("svelte/store").Writable<Partial<{
            label: string;
            description: string;
            field: string;
            validation: string;
