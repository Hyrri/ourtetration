...
export declare const createToggleGroup: <T extends ToggleGroupType = "single">(props?: CreateToggleGroupProps<T> | undefined) => {
    ...
    options: {
        ...
        onValueChange?: import("svelte/store").Writable<import("../../internal/helpers/index.js").ChangeFn<string | string[] | undefined> | undefined> | undefined;
        defaultValue: import("svelte/store").Writable<string | (T extends "single" ? string : string[])>;
        loop: import("svelte/store").Writable<boolean>;
        orientation: import("svelte/store").Writable<import("../../internal/types.js").Orientation>;
        rovingFocus: import("svelte/store").Writable<boolean>;
    };
};
