...
export type FieldProps_<T extends Record<string, unknown>, U extends FormPath<T>> = ReturnType<__sveltets_Render<T, U>['props']>;
export type FieldEvents<T extends Record<string, unknown>, U extends FormPath<T>> = ReturnType<__sveltets_Render<T, U>['events']>;
export type FieldSlots<T extends Record<string, unknown>, U extends FormPath<T>> = ReturnType<__sveltets_Render<T, U>['slots']>;
/**
 * ## Field
 ...
 */
export default class Field<T extends Record<string, unknown>, U extends FormPath<T>> extends SvelteComponent<FieldProps_<T, U>, FieldEvents<T, U>, FieldSlots<T, U>> {
}
export {};
